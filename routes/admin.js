...
import {vedorList,singleVendor,vedorChangeStatus,vendorOrderList,getMLMUser,upateMLMMemberStatus,getnewMLMUser,getBankDetails,getAllUserDetails,getSingleUser,getHightestCoin,widthdrawFunstionality,withdrawStatus,ecomerceOrders,loginEcommerce,orderItemsByOrder,updateUserKYCBank} from '../controllers/adminController/adminController.js'
...
.put('/withdrawStatus/:id',withdrawStatus)
.get('/eco/orders',ecomerceOrders)
.get('/eco/orderItems/:orderId',orderItemsByOrder)
.post('/eco/login',loginEcommerce)
.put('/aprovalBankKYC/:userId',updateUserKYCBank)
